        ...
        <div className="card-color2">
          ...
          <ul>
            ...
            <li className="events-list">
              Provide leadership, team-building, and managing experience to both
              attendees and volunteers.{" "}
            </li>
            <li className="events-list">
              Establish a stronger relationship with alumni and corporations to
              be involved in future PCED events.
            </li>
