...
{/* Main Picture */}
  <div className="box1">
    ...
    <img src={SHPE_Convention} className="Main-Picture" alt="Convention Group"/>
  </div>
  ...
  <div className="box2">
    <h2> About LAESA-SHPE </h2>
      <p className="body">
        ...
        dedicated students, to unite all Latino and other
...
In addition, the headers also need to be changed manually. */}
